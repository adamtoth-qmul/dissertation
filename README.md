...
* Improved cross-validation techniques and algorithm selection (either standalone or ensemble methods) can also improve the performance of a proposed CCF detection architecture by combining multiple classifiers, resulting in reduced generalisation error of predictions (Thennakoon et al., 2019).
